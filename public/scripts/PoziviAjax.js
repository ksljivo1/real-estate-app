const PoziviAjax = (() => {
    ...
    function getTop5Nekretnina(lokacija, fnCallback) {
        ajaxRequest('GET', `http://localhost:3000/nekretnine/top5?lokacija=${encodeURIComponent(lokacija)}`, null, fnCallback)
    }

    function getMojiUpiti(fnCallback) {
        ajaxRequest('GET', 'http://localhost:3000/upiti/moji', null, fnCallback)
    }
