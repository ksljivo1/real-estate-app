window.onload = function () {
  ...
  function updateMenuForLoginStatus(loggedIn) {
    ...
    const mojiUpiti = document.getElementById('mojiUpiti');

    // Ako je korisnik prijavljen, pokažite opciju "Profil", inače pokažite opcije "Nekretnine", "Detalji" i "Prijava"
    if (loggedIn) {
      profilLink.style.display = 'grid';
      nekretnineLink.style.display = 'grid';
      // detaljiLink.style.display = 'grid';
      prijavaLink.style.display = 'none';
      odjavaLink.style.display = 'grid';
      profilLink.style.display = 'grid';
      mojiUpiti.style.display = 'grid'
    } else {
      profilLink.style.display = 'none';
      nekretnineLink.style.display = 'grid';
      // detaljiLink.style.display = 'grid';
      prijavaLink.style.display = 'grid';
      odjavaLink.style.display = 'none';
      mojiUpiti.style.display = 'none'
    }
  }
